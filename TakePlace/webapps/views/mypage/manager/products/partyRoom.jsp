          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item dropdown-btn">
              ...
              <ul style="display: none;">
	            ...
	            <li class="nav-item">
	              <a class="nav-link active" href="http://localhost:8088/takeplace/views/mypage/manager/products/partyRoom.jsp">파티룸</a>
	            </li>
	            <li class="nav-item">
			...
			<div class="container" >
				<nav aria-label="breadcrumb">
				  <ol class="breadcrumb">
				    ...
				    <li class="breadcrumb-item active" aria-current="page">파티룸</li>
				  </ol>
				</nav>
				<h2 class="content-title">파티룸</h2>
