        ...
        <div class="sidebar-sticky">
          <ul class="nav flex-column">
            ...
            <li class="nav-item dropdown-btn">
              <a class="nav-link active" href="#">상품 관리<i class="fa fa-chevron-down"></i></a>
              <ul style="display: none;">
	            ...
	            <li class="nav-item">
	              <a class="nav-link active" href="http://localhost:8088/takeplace/views/mypage/manager/products/seminarRoom.jsp">세미나룸</a>
	            </li>
	            <li class="nav-item">
			...
			<div class="container" >
				<nav aria-label="breadcrumb">
				  <ol class="breadcrumb">
				    ...
				    <li class="breadcrumb-item active" aria-current="page">세미나룸</li>
				  </ol>
				</nav>
				<h2 class="content-title">세미나룸</h2>
