          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item dropdown-btn">
              ...
              <ul style="display: none;">
              	<li class="nav-item">
	              <a class="nav-link active" href="http://localhost:8088/takeplace/views/mypage/manager/products/studyRoom.jsp">스터디룸</a>
	            </li>
	            <li class="nav-item">
			...
			<div class="container" >
				<nav aria-label="breadcrumb">
				  <ol class="breadcrumb">
				    ...
				    <li class="breadcrumb-item active" aria-current="page">스터디룸</li>
				  </ol>
				</nav>
				<h2 class="content-title">스터디룸</h2>
