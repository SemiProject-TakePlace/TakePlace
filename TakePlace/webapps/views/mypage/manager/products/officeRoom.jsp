          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item dropdown-btn">
              ...
              <ul style="display: none;">
	            ...
	            <li class="nav-item">
	              <a class="nav-link active" href="http://localhost:8088/takeplace/views/mypage/manager/products/officeRoom.jsp">오피스</a>
	            </li>
              </ul>
            </li>
            <li class="nav-item">
			...
			<div class="container" >
				<nav aria-label="breadcrumb">
				  <ol class="breadcrumb">
				    ...
				    <li class="breadcrumb-item active" aria-current="page">오피스룸</li>
				  </ol>
				</nav>
				<h2 class="content-title">오피스룸</h2>
