	...
	<nav class="d-none d-md-block bg-light sidebar">
        <div class="sidebar-sticky">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="http://localhost:8088/takeplace/views/mypage/manager/review/reviewList.jsp">이용 후기</a>
            </li>
            <li class="nav-item">
	...
	<section id="wrap-contents">
		<div class="mypage-content">
         ...
         <!-- 회원가입 시작 -->
              ...
              <div class="tab-pane fade" id="nav-complete" role="tabpanel" aria-labelledby="nav-host-tab">
