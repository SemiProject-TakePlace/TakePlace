	...
	<section id="wrap-contents">
		<div class="mypage-content">
			<div class="container">
             ...
             <div class="form-group">
                <label for="userid" class="font-green inline-block" >회사명</label>
                <input type="text" class="form-control inline-block" id="userid" aria-describedby="emailHelp" placeholder="kh정보교육원" maxlength="20">
              </div>
                 
              <div class="form-group">
                <label for="userNick" class="font-green inline-block" >사업자명</label>
                <input type="text" class="form-control inline-block" id="userNick" aria-describedby="emailHelp" placeholder="HOST상호명">
              </div>
              <div class="form-group">
                <label for="userNick" class="font-green inline-block" >사업자 등록번호</label>
                <input type="text" class="form-control inline-block" id="userNick" aria-describedby="emailHelp" placeholder="00-12345678">
              </div>
              <div class="form-group">
                  <label for="userEmail" class="font-green inline-block" >이메일</label>
                <input type="text" class="form-control inline-block" id="userEmail" aria-describedby="emailHelp" placeholder="host01@example.com">
              </div>
